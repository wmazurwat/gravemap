        ...
        {activePerson && (
          ...
          >
            <div style={{ maxWidth: '200px' }}>
              <strong>{activePerson.firstName} {activePerson.lastName}</strong><br />
              ur. {activePerson.birthDate} w {activePerson.birthPlace}<br />
              zm. {activePerson.deathDate} w {activePerson.deathPlace}<br />
